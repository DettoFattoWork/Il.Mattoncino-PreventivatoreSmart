...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    loginBtn.addEventListener('click', function() {
        ...
        // Credenziali: mattoncino / 1234
        if (user === 'mattoncino' && pass === '1234') {
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 11px;">
                <thead>
                    <tr style="background: #1F3E7C; color: white;">
                        <th style="padding: 8px; text-align: left; border: 1px solid #ddd; word-wrap: break-word; white-space: normal;">Descrizione della lavorazione</th>
                        <th style="padding: 8px; text-align: center; border: 1px solid #ddd; word-wrap: break-word; white-space: normal;">Unità di Misura</th>
